...
class Cells
{
    ...
    /**
     * Return the cell coordinate of the currently active cell obj.
     *
     * @return string
     */
    ...
    /**
     * Return the column coordinate of the currently active cell obj.
     *
     * @return string
     */
    ...
    /**
     * Return the row coordinate of the currently active cell obj.
     *
     * @return int
     */
    ...
    /**
     * Store cell data in cache for the current cell obj if it's "dirty",
     * and the 'nullify' the current cell obj.
     *
     * @throws PhpSpreadsheetException
     */
    ...
    public function unsetWorksheetCells()
    {
        ...
        // detach ourself from the worksheet, so that it can then delete this obj successfully
        $this->parent = null;
    }
