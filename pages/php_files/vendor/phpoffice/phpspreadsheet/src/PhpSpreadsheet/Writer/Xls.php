...
class Xls extends BaseWriter
{
    ...
    /**
     * Basic OLE obj summary information.
     *
     * @var array
     */
    ...
    /**
     * Extended OLE obj document summary information.
     *
     * @var array
     */
     ...
     *
     * @param Spreadsheet $spreadsheet PhpSpreadsheet obj
     */
    ...
    public function save($pFilename)
    {
        ...
        // build Escher objects. Escher objects for workbooks needs to be build before Escher obj for workbook.
    ...
    private function buildWorksheetEschers()
    {
        ...
        foreach ($this->spreadsheet->getAllsheets() as $sheet) {
            ...
            // create intermediate Escher obj
            $escher = new Escher();
            ...
            // identifier clusters, used for workbook Escher obj
    ...
    /**
     * Build the Escher obj corresponding to the MSODRAWINGGROUP record.
     */
