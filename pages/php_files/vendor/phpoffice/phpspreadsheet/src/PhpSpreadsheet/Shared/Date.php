...
class Date
{
     ...
     *
     * @return DateTimeZone The timezone being used as default for Excel timestamp to PHP DateTime obj
     */
     ...
     * Validate a timezone.
     *
     * @param DateTimeZone|string $timeZone The timezone to validate, either as a timezone string or obj
     *
     * @throws \Exception
     *
     * @return DateTimeZone The timezone as a timezone obj
     * @return DateTimeZone The timezone as a timezone obj
     */
    ...
    /**
     * Convert a MS serialized datetime value from Excel to a PHP Date/Time obj.
     *
     ...
     * @throws \Exception
     *
     * @return \DateTime PHP date/time obj
     */
     ...
     *
     * @param mixed $dateValue Unix Timestamp or PHP DateTime obj or a string
     *
    ...
    /**
     * Convert a PHP DateTime obj to an MS Excel serialized date/time value.
     *
     * @param DateTimeInterface $dateValue PHP DateTime obj
     *
