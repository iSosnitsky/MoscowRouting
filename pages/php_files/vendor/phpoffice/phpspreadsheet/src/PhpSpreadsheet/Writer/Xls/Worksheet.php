...
class Worksheet extends BIFFwriter
{
    ...
    /**
     * Escher obj corresponding to MSODRAWING.
     *
...
//        if ($this->firstColumnIndex > 255) $this->firstColumnIndex = 255;
     ...
     *        percentage of 1024.
     *
     * @param int $col_start Col containing upper left corner of obj
     * @param int $row_start Row containing top left corner of obj
     * @param int $x1 Distance to left side of obj
     * @param int $y1 Distance to top of obj
    ...
    public function positionImage($col_start, $row_start, $x1, $y1, $width, $height)
    {
        ...
        $col_end = $col_start; // Col containing lower right corner of obj
        $row_end = $row_start; // Row containing bottom right corner of obj
        ...
        $x2 = $width / Xls::sizeCol($this->phpSheet, Coordinate::stringFromColumnIndex($col_end + 1)) * 1024; // Distance to right side of obj
        $y2 = $height / Xls::sizeRow($this->phpSheet, $row_end + 1) * 256; // Distance to bottom of obj
     ...
     *
     * @param int $colL Column containing upper left corner of obj
     * @param int $dxL Distance from left side of cell
     * @param int $rwT Row containing top left corner of obj
     * @param int $dyT Distance from top of cell
     * @param int $colR Column containing lower right corner of obj
     * @param int $dxR Distance from right of cell
     * @param int $rwB Row containing bottom right corner of obj
    ...
    private function writeMsoDrawing()
    {
        ...
        if (isset($this->escher)) {
            ...
            for ($i = 1; $i <= $nm; ++$i) {
                ...
                // ftCmo
                if ($spTypes[$i] == 0x00C9) {
                    // Add ftCmo (common obj data) subobject
                    $objData .=
                        pack(
                            'vvvvvVVV',
                            0x0015, // 0x0015 = ftCmo
                            0x0012, // length of ftCmo data
                            0x0014, // obj type, 0x0014 = filter
                            $i, // obj id number, Excel seems to use 1-based index, local for the sheet
                    ...
                    $objData .=
                        pack(
                            ...
                            0x0015, // 0x0015 = ftCmo
                            0x0012, // length of ftCmo data
                            0x0008, // obj type, 0x0008 = picture
                            $i, // obj id number, Excel seems to use 1-based index, local for the sheet
    ...
    private function writeDataValidity()
    {
        ...
        if (!empty($dataValidationCollection)) {
            ...
            $objId = 0xFFFFFFFF; // Object identifier of drop down arrow obj, or -1 if not visible
