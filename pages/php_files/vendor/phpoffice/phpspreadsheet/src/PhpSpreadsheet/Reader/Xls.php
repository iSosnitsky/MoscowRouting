...
//     Added Parse_Excel_Spreadsheet obj
//         Reads a whole worksheet or tab as row,column array or as
//         associated hash of indexed rows and named column fields
//     Added variables for worksheet (tab) indexes and names
//     Added an obj call for loading individual woorksheets
...
class Xls extends BaseReader
{
    ...
    /**
     * The current RC4 decryption obj.
     *
     * @var Xls\RC4
     */
    private $rc4Key;
    ...
    /**
     * The position in the stream that the RC4 decryption obj was left at.
     *
     * @var int
     */
    private $rc4Pos = 0;
    ...
    /**
     * Reads names of the worksheets from a file, without parsing the whole file to a PhpSpreadsheet obj.
     *
     * @param string $pFilename
     *
     * @throws Exception
    ...
    public function load($pFilename)
    {
        ...
        foreach ($this->sheets as $sheet) {
            ...
            // add sheet to PhpSpreadsheet obj
...
//                                                    ->setAuthor($author)
    ...
    private function readObj()
    {
        ...
        // for now, we are just interested in the second subrecord containing the obj type
